...
export const en: Messages = {
  ...
  chat: {
    ...
    toolTypeTask: "Task",
    agentTasksLeft: "Subagent tasks · {{count}} left",
    agentTasksDone: "All subagent tasks completed",
    agentTasksExpand: "Expand subagent tasks",
    agentTasksMinimize: "Minimize subagent tasks",
