...
export const en: Messages = {
  ...
  settings: {
    ...
    webLan: "LAN",
    webWan: "Internet",
    webRelayDeployHint: "Remote access needs a relay: deploy deploy/worker to your own Cloudflare account (or try deploy/worker/local-relay.mjs locally), then fill in its address and key above.",
    ...
    webAuthDesc: "New devices must type the pairing key once; approved ones are never asked again.",
    webAuthEnable: "Turn on",
    webAuthDisable: "Turn off",
    webAuthKeyHint: "Give this key to the device you want to approve (turning it on again mints a new one)",
    webDevices: "Approved devices",
    webDevicesDesc: "Revoke any time; a revoked device must type the key again.",
    ...
    webDeviceApprove: "Allow",
    webDeviceDeny: "Deny",
    webDeviceRevoke: "Revoke",
    webRelay: "Remote access",
    webRelayStart: "Connect relay",
    webRelayStop: "Disconnect relay",
    webRelayDesc: "The desktop dials out to a relay worker, so the phone reaches it from any network - no open port, no port-forwarding.",
    webRelayUrl: "Relay address",
    webRelayKey: "Relay key",
    webRelayKeyHint: "Must match RELAY_KEY set when the relay was deployed",
    webRelayConnecting: "Connecting to the relay…",
    webRelayConnected: "Relay connected",
    webRelayFailed: "Relay error",
    webRelayPhoneHint: "Open this address from anywhere: a new device types the pairing key once - no token in the URL",
    webAccessScanHint:
