export const zh = {
  ...
  settings: {
    ...
    webLan: "内网访问",
    webWan: "外网访问",
    webRelayDeployHint: "外网访问需要一个中转服务：把 deploy/worker 里的代码部署到自己的 Cloudflare 账号（或用本机的 local-relay.mjs 试跑），再把地址和密钥填到上面。",
    ...
    webAccessUrl: "访问地址",
    webAuth: "授权访问",
    webAuthDesc: "开启后新设备需输入配对密钥才能进入；已授权的设备不再询问。",
    webAuthEnable: "启用授权",
    webAuthDisable: "关闭授权",
    webAuthKeyHint: "把这串密钥告诉你要授权的设备（重新开启会换新密钥）",
    webDevices: "已授权设备",
    webDevicesDesc: "可随时撤销；撤销后该设备需要重新输密钥。",
    ...
    webRelayStart: "连接中转",
    webRelayStop: "断开中转",
    webRelayDesc: "桌面端主动连到中转服务，手机在外网也能打开本机；无需开端口或路由器映射。",
    webRelayUrl: "中转地址",
    webRelayKey: "中转密钥",
    webRelayKeyHint: "与部署中转时设置的 RELAY_KEY 一致",
    webRelayConnecting: "正在连接中转…",
    webRelayConnected: "已连接中转",
    webRelayFailed: "中继异常",
    webRelayPhoneHint: "手机在外网直接打开这个地址：新设备输一次配对密钥即可，无需再带 token",
